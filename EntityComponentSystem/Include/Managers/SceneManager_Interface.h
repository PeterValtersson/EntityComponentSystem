...
namespace ECS
{
	...
	{
	public:
		DECLDIR_ECS static std::shared_ptr<SceneManager_Interface> create( SceneManager_Init_Info init_info );
		...
		virtual uint32_t GetNumberOfChildResourcesOfSceneResource( Resources::Resource resource )const = 0;
